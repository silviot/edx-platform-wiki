...
参会：@冬日暖阳 @种瓜 @MT @黄文杰
内容：
* 社区的目标为推广Open edX在国内的应用，推动Open edX研发技术的普及
* 社区的组成包括开发者和用户
* 将发布基于Docker的Open edX国内版本 
* 建立技术委员会，用户委员会
* 技术委员会制定基于Docker版本的开发规范、开发方法
* 技术委员会负责审核和发布代码提交流程规范
* 将在北京举行Open edX线下交流活动
* 将组织社区技术力量编撰出版《Open edX开发指南》
* 欢迎有研发能力和愿意奉献时间的开发者加入
