...
See the [[Test Engineering FAQ]] for all your questions about testing the edX platform. You can also find [detailed information on running unit, integration and acceptance tests](https://github.com/edx/edx-platform/blob/master/docs/testing.rst) in the latest platform docs.
